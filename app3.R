...
#setwd("C:/Users/PC/Google Drive (nedob.pictures@gmail.com)/1. fajllat komplet/2022. UniLu/1. Fall 22/Shiny app")


course_data <- readRDS("europe (1).rds") %>% # Load the course data
